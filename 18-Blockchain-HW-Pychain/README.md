...
This Pychain demo allows you to create a block by inputting Sener , Receiver and Amount and display the record in a Dataframe table in streamlit running code. On the left hand side there is a drop down to select the block interested in and it will show the contents of that block (see screenshots for example) The Validate chain validate that the chain has not been modified and returns  True | False boolean and display value to streamlit application;

## Screenshots of Pychain streamlit application ##

### Genesis Block
![alt="Genesis Block"](Images/Pychain-Genesis0.png)

### Blocks 1-3
![alt="Block1"](Images/Pychain-Block1.png)
![alt="Block2"](Images/Pychain-Block2.png)
![alt="Block3"](Images/Pychain-Block3.png)

### Validate Button 
![alt="GValidate"](Images/Pychain-Validate.png)
